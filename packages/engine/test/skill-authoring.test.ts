...
// ---------------------------------------------------------------------------
// classifySkillLint — one profile policy (spec A4). Semantics preserve the CLI `skill lint` selection verbatim.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Real corpus parity — before/after lint decisions (spec A4). The pre-fix dsh gate classified every
